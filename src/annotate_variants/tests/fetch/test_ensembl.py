...
def test_load_variant_annotations(_):
    happy_path_test_cases = [
        ...
        },
        {
            ...
            'expected_output': [
                {
                    'input variant': 'NC_000001.11:g.40819893G>A',
                    'assembly name': 'GRCh38',
                    'seq_region_name': '1',
                    'start': 40819893,
                    'end': 40819893,
        ...
        },
        {
            ...
            'expected_output': [
                {
                    'input variant': 'NC_000002.12:g.39006443C>T',
                    'assembly name': 'GRCh38',
                    'seq_region_name': '2',
                    'start': 39006443,
                    'end': 39006443,
                    ...
                    'genes': ['SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1', 'SOS1']
                }
            ]
        },
        {
